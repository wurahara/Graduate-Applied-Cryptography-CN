...
\draw (15,70) node [anchor=west] [inner sep=0.75pt]    {$b\overset{\mathrm{R}}{\leftarrow}\{0,1\}$};
\draw (15,95) node [anchor=west] [inner sep=0.75pt]    {$s\overset{\mathrm{R}}{\leftarrow}\{0,1\}^{\ell}$};
\draw (15,120) node [anchor=west] [inner sep=0.75pt]    {$r\overset{\mathrm{R}}{\leftarrow} G(s)$};
\draw (15,145) node [anchor=west] [inner sep=0.75pt]    {$c\leftarrow r[0\dotsc v-1]\oplus m_{b}$};
