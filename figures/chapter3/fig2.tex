...
%Shape: Rectangle [id:dp4223684446479663] 
\draw  [line width=1.2]  (0,0) -- (180,0) -- (180,250) -- (0,250) -- cycle ;
%Shape: Rectangle [id:dp9023568603214351] 
\draw  [line width=1.2]  (310,0) -- (430,0) -- (430,250) -- (310,250) -- cycle ;
%Straight Lines [id:da3529710553057679] 
...
%Straight Lines [id:da475403877398743] 
...
%Straight Lines [id:da008143223924291565] 
\draw    (310,60) -- (183,60) ;
...
% Text Node
\draw (15,90) node [anchor=west] [inner sep=0.75pt]    {$s\overset{\mathrm{R}}{\leftarrow }\{0,1\}^{\ell }$};
% Text Node
