...
\draw (460,145) node    {$\prod $};
\draw (460,55) node    {$\mathrm{pad}( \cdot ,\mathbf{2} ,\textcolor[rgb]{0.61,0.61,0.61}{0})$};
\draw (20,15) node   [align=left] {种子};
\draw (140,210) node    {$\bigoplus $};
\draw (300,210) node    {$\bigoplus $};
\draw (460,210) node    {$\bigoplus $};
\draw (140,255) node   [align=left] {输出分组 \#$ 0$};
\draw (300,255) node   [align=left] {输出分组 \#$ 1$};
\draw (460,255) node   [align=left] {输出分组 \#$ 2$};
\draw (180,85) node   [align=left] {$ 512$ 比特};
\draw (140,285) node   [align=left] {$ 512$ 比特};
\draw (300,285) node   [align=left] {$ 512$ 比特};
\draw (460,285) node   [align=left] {$ 512$ 比特};
\draw (560,55) node   [align=left] {$ \cdots $};
\draw (560,255) node   [align=left] {$ \cdots $};
\draw (-3,45) node [anchor=west] [inner sep=0.75pt]   [align=left] {$ 256$ 比特};
