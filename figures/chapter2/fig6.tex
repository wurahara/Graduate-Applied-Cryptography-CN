...
\draw (32,245) node [anchor=west] [inner sep=0.75pt]    {$c\overset{\mathrm{R}}{\leftarrow } E( \lambda ,\Lambda ;k,m_{b})$};

\draw (235,168) node [anchor=south] [inner sep=0.75pt] [font=\small]  {$\Lambda $};
\draw (235,203) node [anchor=south] [inner sep=0.75pt] [font=\small]  {$m_{0} ,m_{1} \in \mathcal{M}_{\lambda ,\Lambda }$};
