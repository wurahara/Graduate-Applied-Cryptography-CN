...
\draw  [->]  (25,195) -- (25,220) ;
\draw  [->]  (95,195) -- (95,220) ;
\draw  [->]  (165,195) -- (165,220) ;
\draw  [->]  (235,195) -- (235,220) ;
\draw  [->]  (305,195) -- (305,220) ;
\draw  [->]  (375,195) -- (375,220) ;
\draw  [->]  (445,195) -- (445,220) ;
\draw  [->]  (515,195) -- (515,220) ;

\draw  [->]  (270,180) -- (270,195) ;
\draw  [->]  (165,110) -- (165,130) ;
\draw  [->]  (165,60) -- (165,80) ;
\draw  [->]  (270,295) -- (270,320) ;
\draw  [->]  (270,340) -- (270,360) ;
\draw  [->]  (270,390) -- (270,410) ;
