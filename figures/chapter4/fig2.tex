...
\draw  [->]  (290,140) -- (181,140) ;
\draw  [->]  (180,180) -- (289,180) ;
\draw  [->]  (290,220) -- (181,220) ;

\draw  [->]  (290,440) -- (181,440) ;
\draw  [->]  (180,480) -- (289,480) ;
\draw  [->]  (290,520) -- (181,520) ;
...
\draw (45,155) node [anchor=west] [inner sep=0.75pt]    {$y_{i}\leftarrow E( k,x_{i})$};
...
\draw (45,455) node [anchor=west] [inner sep=0.75pt]    {$y_{i}\leftarrow f( x_{i})$};
