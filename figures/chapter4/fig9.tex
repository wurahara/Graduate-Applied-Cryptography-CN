...
\draw  [->]  (25,120) -- (59,120) ;
\draw  [->]  (90,120) -- (124,120) ;
\draw  [->]  (315,120) -- (349,120) ;
\draw  [->]  (380,120) -- (414,120) ;

\draw  [->]  (190,20) -- (150,50) -- (150,79) ;
\draw  [->]  (205,20) -- (180,50) -- (180,79) ;
\draw  [->]  (220,20) -- (220,79) ;
\draw  [->]  (250,20) -- (290,50) -- (290,79) ;

\draw (12.5,120) node  [rotate=-270] [align=left] [font=\small]{$64$ 比特};
\draw (427.5,120) node  [rotate=-270] [align=left][font=\small] {$64$ 比特};
\draw (220,120) node   [align=left] {$16$ 轮 Feistel 网络};
\draw (220,10) node   [align=left][font=\small] {$56$比特密钥};
\draw (75,120) node   [align=left] {IP};
\draw (365,120) node   [align=left] {FP};
\draw (152,53.4) node [anchor=north west][inner sep=0.75pt] [font=\small] {$k_{1}$};
\draw (182,53.4) node [anchor=north west][inner sep=0.75pt] [font=\small] {$k_{2}$};
\draw (222,53.4) node [anchor=north west][inner sep=0.75pt] [font=\small] {$k_{2}$};
\draw (292,53.4) node [anchor=north west][inner sep=0.75pt] [font=\small] {$k_{16}$};
\draw (252,55) node [anchor=north west][inner sep=0.75pt] [font=\small] {$\cdots $};
